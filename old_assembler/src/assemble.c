...
struct opcode_def opcodes[] = {
    ...
    {   "LDHS",     0x80,       assemble_type_rm    },
    {   "ADH",      0x81,       assemble_type_rm    },
    {   "ADHS",     0x82,       assemble_type_rm    },
    {   "SDH",      0x83,       assemble_type_rm    },
    {   "SDHS",     0x84,       assemble_type_rm    },
    {   "AD",       0x85,       assemble_type_rm    },
    {   "SD",       0x86,       assemble_type_rm    },
    {   "CD",       0x87,       assemble_type_rr    },
    {   "CB",       0x88,       assemble_type_rr    },
    {   "CDS",      0x89,       assemble_type_rr    },
    {   "CLDHS",    0x8A,       assemble_type_rr    },
    {   "ADR",      0x8B,       assemble_type_rr    },
    {   "SDR",      0x8C,       assemble_type_rr    },
    {   "NED",      0x8D,       assemble_type_rr    },
    {   "EDC",      0x8E,       assemble_type_rr    },
